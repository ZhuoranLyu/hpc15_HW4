...
void ppma_read ( const char *input_name, int *xsize, int *ysize, int *rgb_max,
  int **r, int **g, int **b )
...
int ppma_write ( const char *file_out_name, int xsize, int ysize, int *r,
  int *g, int *b )
...
int ppma_write_header ( FILE *file_out, const char *file_out_name, int xsize,
